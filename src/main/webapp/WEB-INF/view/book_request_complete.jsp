...
<div>
    ...
    <header  class="cd-main-header text-center flex flex-column flex-center">
        <h1 class="text-xl"><br><br><br>Booking Request Successful !</h1>
        <h3 class="text-xl-center"><br><br><br>Notification will be sent on final allotment</h3>
        <img src="<c:url value="/resources/img/thumbsup.png"/>"/>
    </header>
</div>
</body>
</html>
