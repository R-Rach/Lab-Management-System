...
<div>
    <header  class="cd-main-header text-center flex flex-column flex-center">
        <br><br>
        <h1 class="text-xl">IPC 6018 Lab Schedule  (<c:out value="${Schedule_6018[0].date}"></c:out>) </h1>
    </header>
</div>
<div>
        ...
        <ul>
            <li class="cd-schedule__group">
                <div class="cd-schedule__top-info"><span>Booking Time Table (Select Other Date) &nbsp; &nbsp; &nbsp;</span>
                    <form:form method="post" class="form-inline"  action="6018_schedule" modelAttribute="date6018">
                ...
                <ul>
                    <c:forEach items="${Schedule_6018}" var="schedule">
