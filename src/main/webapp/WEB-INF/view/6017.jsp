...
<header  class="cd-main-header text-center flex flex-column flex-center">
    <br><br>
    <h1 class="text-xl">IPC 6017 Lab Schedule  (<c:out value="${Schedule_6017[0].date}"></c:out>) </h1>
</header>
    ...
    <div class="cd-schedule__events">
        <ul>
            <li class="cd-schedule__group">
                ...
                <form:form method="post" class="form-inline"  action="6017_schedule" modelAttribute="date">
                ...
                <ul>
                <c:forEach items="${Schedule_6017}" var="schedule">
